...
@section('content')
<h1><i class="fas fa-plus-circle me-2"></i>Add User</h1>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="password" class="form-label"><i class="fas fa-key me-1"></i>Password</label>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control @error('role') is-invalid @enderror" id="role" name="role" required>
                        ...
                        <option value="Agent" {{ old('role') == 'Agent' ? 'selected' : '' }}>Agent (for Commission)</option>
                    </select>
                    @error('role')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                                ...
                                <div class="card-body p-3">
                                    @foreach($groupMenus as $menuKey)
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="menu_permissions[]" id="menu_{{ $menuKey }}" value="{{ $menuKey }}" {{ in_array($menuKey, old('menu_permissions', [])) ? 'checked' : '' }}>
