    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-user-plus me-2 text-primary"></i>Add New Customer</h1>
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-lg custom-input shadow-none" id="name" name="name" value="{{ old('name') }}" placeholder="Enter full name" required>
                            </div>
                            <div class="col-md-6">
                                <label for="phone" class="form-label fw-semibold"><i class="fas fa-phone me-2 text-muted"></i>Phone Number</label>
                                <input type="text" class="form-control form-control-lg custom-input shadow-none" id="phone" name="phone" value="{{ old('phone') }}" placeholder="+92 3XX XXXXXXX" required>
                            </div>
                            <div class="col-md-6">
                                <label for="email" class="form-label fw-semibold"><i class="fas fa-envelope me-2 text-muted"></i>Email Address</label>
                                <input type="email" class="form-control form-control-lg custom-input shadow-none" id="email" name="email" value="{{ old('email') }}" placeholder="example@domain.com" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-select-lg custom-input shadow-none" id="type" name="type" required>
                                    <option value="Un-Official" {{ old('type') == 'Un-Official' ? 'selected' : '' }}>Un-Official</option>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control custom-input shadow-none" id="address" name="address" rows="3" placeholder="Enter complete office or business address" required>{{ old('address') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control form-control-lg custom-input shadow-none" id="opening_balance" name="opening_balance" value="{{ old('opening_balance', '0.00') }}" placeholder="0.00">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control form-control-lg custom-input shadow-none" id="excess_qty_percent" name="excess_qty_percent" value="{{ old('excess_qty_percent', '0.00') }}" placeholder="0.00" min="0" max="100">
